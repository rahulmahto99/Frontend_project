        ...
        <div className="container pt-7 flex">
          <div className="first basis-5/12">
            <div className="overflow-hidden">
              <div className="bg-[url('https://new-ella-demo.myshopify.com/cdn/shop/files/home-9-banner-product-tab-3.jpg?v=1640936300')] h-full pb-96 bg-no-repeat bg-cover pt-10 pl-8 hover:scale-105 p-52 hover:transition-all"></div>
            </div>
          </div>
