...
function Section1() {
  return (
    /*<div classNameName="bg-gray-200 p-4 rounded-md shadow-md">
...
<div className="max-w-6xl mx-auto py-12">
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="flex flex-col md:flex-row items-center p-6">
                <img src="https://demo2.pavothemes.com/insul/wp-content/uploads/2024/04/h1-faq.jpg" alt="Team High Five" className="w-1/2 rounded-lg"/>
                <div className="w-1/2 pl-6">
                    <h3 className="text-blue-600 italic font-bold "> 🧿PRICING FAQS</h3>
                    <h2 className="text-3xl font-bold mb-4">Frequently asked questions</h2>
                    <p className="text-gray-600 mb-6">
                        There are questions that you might ask about our pricing plans and service. Contact us for more info on page <br></br>
                        <a href="#" className="text-blue-600">Contact us</a>
                    </p>
                    <div>
                        <div className="mb-4">
                            <button className="flex justify-between w-full p-4 text-left text-xl font-medium text-gray-900 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-500">
                                01. What is it that makes you stand out in the industry?
                                <svg className="w-5 h-5 ml-2 transform rotate-0 transition-transform" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06 0L10 10.94l3.71-3.73a.75.75 0 111.06 1.06l-4 4a.75.75 0 01-1.06 0l-4-4a.75.75 0 010-1.06z" clip-rule="evenodd"></path>
                                </svg>
                            </button>
                            <div className="p-4 text-gray-700 bg-gray-50 rounded-lg hidden">
                                Of course, I’d be happy to help you with a business review. However, could you please provide more specific details about the business you’d like to review? Are you looking for a review of a particular company’s.
                            </div>
                        </div>
                        <div className="mb-4">
                            <button className="flex justify-between w-full p-4 text-left text-xl font-medium text-gray-900 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-500">
                                02. In which countries can I find your company?
                                <svg className="w-5 h-5 ml-2 transform rotate-0 transition-transform" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06 0L10 10.94l3.71-3.73a.75.75 0 111.06 1.06l-4 4a.75.75 0 01-1.06 0l-4-4a.75.75 0 010-1.06z" clip-rule="evenodd"></path>
                                </svg>
                            </button>
                        ...
                        <div className="mb-4">
                            <button className="flex justify-between w-full p-4 text-left text-xl font-medium text-gray-900 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-500">
                                03. Which industries does your company provide its services?
                                <svg className="w-5 h-5 ml-2 transform rotate-0 transition-transform" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06 0L10 10.94l3.71-3.73a.75.75 0 111.06 1.06l-4 4a.75.75 0 01-1.06 0l-4-4a.75.75 0 010-1.06z" clip-rule="evenodd"></path>
                                </svg>
                            </button>
                        ...
                        <div className="mb-4">
                            <button className="flex justify-between w-full p-4 text-left text-xl font-medium text-gray-900 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring focus:ring-gray-500">
                                04. What is your service expertise?
                                <svg className="w-5 h-5 ml-2 transform rotate-0 transition-transform" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06 0L10 10.94l3.71-3.73a.75.75 0 111.06 1.06l-4 4a.75.75 0 01-1.06 0l-4-4a.75.75 0 010-1.06z" clip-rule="evenodd"></path>
                                </svg>
                            </button>
